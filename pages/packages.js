...
const packagesData = {
  ...
  packageList: [
    ...
    },
    {
      ...
      description:
        "För de som publicerar dagligen eller flera gånger per vecka på sociala medier och vill ha content för 3 månader.",
      features: [
    ...
    },
    {
      ...
      description:
        "För de som publicerar dagligen eller flera gånger per vecka på sociala medier och vill ha content för 6+ månader.",
      features: [
        ...
        <Container>
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {packagesData.packageList.map((packageItem, index) => (
              <div
                key={index}
                className="bg-white p-4 lg:p-12 flex flex-col justify-between"
              >
                <div>
                ...
                <div>
                  <p className="font-bold mb-8">
                    Investering: {packageItem.investment}
                  </p>
                  <a
                    href="mailto:marilia@bognandiphotography.com"
                    className="font-normal px-12 pt-4 pb-3 bg-green-darker text-white hover:bg-green-olive transition-all duration-200"
                    target="_blank"
                    rel="noreferrer"
                  >
                    Jag är redo att boka
                  </a>
                </div>
              </div>
            ))}
