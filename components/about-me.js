...
export default function AboutMe({ title = "", text = "", image = null }) {
  return (
    <section className="bg-beige-light py-12 sm:py-24 text-beige-darkest">
      <Container>
        <div className="flex gap-4 items-stretch max-w-screen-md mx-auto">
          <div className="w-1/2">
            <Image
              data={{
                ...image,
          ...
          <div className="bg-white p-4 lg:p-12 flex flex-col justify-center w-1/2">
            <div>
              <div className="text-8xl font-playfair leading-3">"</div>
